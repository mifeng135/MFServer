...
LUA_API int luaopen_pb_conv_register(lua_State *L) {
    luaL_Reg libs[] = {
...
LUALIB_API int luaopen_pb_conv(lua_State *L) {
    luaL_requiref(L, "pb.conv", luaopen_pb_conv_register, 1);
    lua_pop(L, 1);
    return 1;
}
...
LUALIB_API int luaopen_pb_buffer_reigstr(lua_State *L) {
    luaL_Reg libs[] = {
...
LUALIB_API int luaopen_pb_buffer(lua_State *L) {
    luaL_requiref(L, "pb.buffer", luaopen_pb_buffer_reigstr, 1);
    lua_pop(L, 1);
    return 1;
}
...
LUALIB_API int luaopen_pb_slice_register(lua_State *L) {
    luaL_Reg libs[] = {
...
LUALIB_API int luaopen_pb_slice(lua_State *L) {
    luaL_requiref(L, "pb.slice", luaopen_pb_slice_register, 1);
    lua_pop(L, 1);
    return 1;
}
...
LUALIB_API int luaopen_pb_registger(lua_State *L) {
    luaL_Reg libs[] = {
        { "pack",     Lbuf_pack     },
...
LUALIB_API int luaopen_pb(lua_State *L) { 
    luaL_requiref(L, "pb", luaopen_pb_registger, 1);
    lua_pop(L, 1);
    return 1;
}
...
LUALIB_API int luaopen_pb_unsafe_register(lua_State *L) {
    luaL_Reg libs[] = {
...
LUALIB_API int luaopen_pb_unsafe(lua_State *L) {
    luaL_requiref(L, "pb.unsafe", luaopen_pb_unsafe_register, 1);
    lua_pop(L, 1);
    return 1;
}
